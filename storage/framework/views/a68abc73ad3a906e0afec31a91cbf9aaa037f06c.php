...
<section class="content">
  <div class="panel">
    <form class="space-y-2" id="myForm" action="<?php echo e(route('users.update',$user->id)); ?>" method="POST" autocomplete="off">
      <?php echo csrf_field(); ?>
      ...
      <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
        ...
        <div class="flex-1 max-w-lg space-y-4 sm:space-x-4">
          <div class="flex sm:flex-row flex-col" id="FirstNameField">
            ...
            <input type="text" placeholder="Enter First Name" class="text-xs form-input flex-auto" name="FirstName" id="FirstName" value="<?php echo e($user->FirstName); ?>">
          </div>
          <div class="flex sm:flex-row flex-col" id="LastNameField">
            ...
            <input type="text" placeholder="Enter Last Name" class="text-xs form-input flex-auto" name="LastName" id="LastName" value="<?php echo e($user->LastName); ?>">
          </div>
          <div class="flex sm:flex-row flex-col" id="UserNameField">
             ...
             <input type="text" placeholder="Enter User Name" class="text-xs form-input flex-auto" name="email" id="email" value="<?php echo e($user->email); ?>" autocomplete="off" oninput="this.value = this.value.replace(/\s+/g, '').toLowerCase()">
         </div>
        ...
        <div class="flex-1 max-w-lg space-y-4" style="margin-left: 2.2rem;">
         <div class="flex sm:flex-row flex-col" id="ContactNoField">
            ...
            <input type="text" placeholder="Enter Contact No." class="text-xs form-input flex-auto" x-mask="999-9999999" name="ContactNo" id="ContactNo" value="<?php echo e($user->ContactNo); ?>" autocomplete="off">
         </div>
          <div class="flex sm:flex-row flex-col" id="EmailIdField">
            ...
            <input type="email" placeholder="Enter Email Id" class="text-xs form-input flex-auto" name="EmailId" id="EmailId" value="<?php echo e($user->EmailId); ?>">
          </div>
          <div class="flex sm:flex-row flex-col" id="AddressField">
            ...
            <input type="text" placeholder="Enter Address" class="text-xs form-input flex-auto" name="Address" id="Address" value="<?php echo e($user->Address); ?>">
          </div>
          <div class="flex sm:flex-row flex-col" id="UserNameField">
            ...
            <select id="UserRoleId" name="UserRoleId" class="text-xs flex-1 flex-auto form-input">
               ...
               <?php $__currentLoopData = $userrole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userroles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option <?php echo e($user->UserRoleId == $userroles->id ?'selected':''); ?> value="<?php echo e($userroles->id); ?>"><?php echo e($userroles->UserRoleName); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/users/edit.blade.php ENDPATH**/ ?>