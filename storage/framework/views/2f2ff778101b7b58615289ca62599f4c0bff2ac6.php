...
<script>
	...
	$( "#VisitFor" ).click(function() {
 	 	...
 	 	{
 	 		 alert('Visit Purpose is not null');
 	 	}
	...
	$( "#clickp" ).click(function() {
 	 	...
 	 	{
 	 		 alert('Product Type  is not null');
 	 	}
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\gatepass\resources\views/appdirectory/create.blade.php ENDPATH**/ ?>