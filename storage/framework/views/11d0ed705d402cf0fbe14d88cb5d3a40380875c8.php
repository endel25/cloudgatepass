                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td style="text-align-last: center;" >
                           <label class="switch">
                             <input type="checkbox" <?php echo e(($driver->Active==0)? "" : "checked"); ?> onclick="Blacklist(<?php echo e($driver->id); ?>)">
                             <span class="slider round"></span>
                           </label>
                        </td>
                        <td style="text-align-last: center;" >
                           <label class="switch">
                             <input type="checkbox" <?php echo e(($driver->IsActive==0)? "" : "checked"); ?> onclick="Active(<?php echo e($driver->id); ?>)">
                             <span class="slider round"></span>
                           </label>
                        </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\resources\views/drivers/index.blade.php ENDPATH**/ ?>