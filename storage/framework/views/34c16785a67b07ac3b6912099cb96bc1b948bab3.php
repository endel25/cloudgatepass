	                  ...
	                  <tbody> 
	                   <?php $__currentLoopData = $Loading; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Loading): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
	                     <tr>
	                        ...
	                        <td><?php echo e($Loading->FirstName); ?> <?php echo e($Loading->LastName); ?></td>
	                        <td> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\gatepass\resources\views/OffLoading.blade.php ENDPATH**/ ?>