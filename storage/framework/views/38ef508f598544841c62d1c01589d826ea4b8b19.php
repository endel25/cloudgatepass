	         ...
	         <div class="card">
	            <div class="card-body">
	               <table id="example1" class="table table-bordered table-striped">
	                  ...
	                  <tbody> 
	                   <?php $__currentLoopData = $GatepassIssued; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $PendingEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
	                     <tr>
												            <th>GP<?php
	                        ...
	                        <td><?php echo e($PendingEntry->FirstName); ?> <?php echo e($PendingEntry->LastName); ?></td>
	                        <td> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\gatepass\resources\views/GatepassIssued.blade.php ENDPATH**/ ?>