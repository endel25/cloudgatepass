...
<section class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         ...
         <div class="col-sm-6">
            <h1>In Progress Loading Data Warehouse(#<?php echo e($UserLocations->Warehousenumber); ?>)</h1>
         </div>
                    ...
                    <?php 
                     ...
                     <tr>
                        <form action="<?php echo e(URL::to('/')); ?>/Warehouse_loading" method="POST">
                           ...
                           <td><input type="label" name="whuser"  style="font-size: 14px; width:100%; text-align:center; border: none; background: white; flex: 0 0 0%;" value="<?php echo e($gatepasses->User); ?>" readonly></td>
                           <td style="text-align-last: center;">
                              ...
                              <?php elseif($gatepasses->LoadingStatus == "Loading" ): ?>
                               <button type="submit" <?php if($UserRoleName[0]->UserRoleName=='WarehouseIncharge'): ?> disabled <?php endif; ?> name="LoadingStatus" value="Complete" class="btn btn-block btn-outline-primary btn-xs">Complete</button>
                           </td>
                              <?php endif; ?>
                        </form>
                     </tr>
