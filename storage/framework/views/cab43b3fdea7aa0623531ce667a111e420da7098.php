			...
			<form class="space-y-5" id="myForm" action="<?php echo e(route('vehicles.update',$vehicle->id)); ?>" method="POST">
			    ...
			    <div class="flex sm:flex-row flex-col">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Notes</label>
			       	<textarea class="text-xs flex-1 form-input" name="Notes"><?php echo e($vehicle->Notes); ?></textarea>
			    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloudgatepass\resources\views/vehicles/edit.blade.php ENDPATH**/ ?>