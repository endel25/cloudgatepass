					...
					<div class="col-md-6">
						<div class="row">
							<div class="form-group col-md-6">
			                  ...
			                  <input type="text " name="TransporterId" required="" class="form-control form-control-sm" placeholder="Enter  TransporterID"  autocomplete="off">  
            				</div>
            				<div class="form-group col-md-6">
				                 <label>Transporter Name<sup class="" style="font-size: 7px;"><i class="fas fa-asterisk text-danger"></i></sup></label>
		                  		<input type="text " name="CompanyName" required=""  class="form-control form-control-sm" placeholder="Enter Transporter Name"  autocomplete="off">    
	                		</div>
						</div> 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\resources\views/accounts/create.blade.php ENDPATH**/ ?>