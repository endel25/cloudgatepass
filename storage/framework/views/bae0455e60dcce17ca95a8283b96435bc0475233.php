						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control  form-control-sm" type="text" value="<?php echo e($product->ProductVariance); ?>" name="ProductVariance" placeholder="Enter Product Code" autocomplete="off">
								</div>
							</div>
						</div>
					</div> 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\resources\views/products/edit.blade.php ENDPATH**/ ?>