...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      ...
      <a type="button" href="<?php echo e(route('vehicles.create')); ?>" class="btn btn-sm btn-l btn-primary rounded-full">Add Vehicle</a>
            ...
            <tr>
               ...
               <td style="text-align-last: center;">
                  <label class="relative h-6 w-12">
                     <input
                         ...
                         <?php echo e(($vehicle->IsActive!=0)? "checked" : ""); ?> onclick="Active(<?php echo e($vehicle->id); ?>)"
                     />
                     <span
               ...
               <td>
                  <div class="flex items-center  gap-4" >
                     <a href="<?php echo e(route('vehicles.edit',$vehicle->id)); ?>" title="EDIT">
                    ...
                    <a onclick="showAlert('<?php echo e(URL::to('/')); ?>/vehicles/<?php echo e($vehicle->id); ?>/delete')"  title="DELETE">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/vehicles/index.blade.php ENDPATH**/ ?>