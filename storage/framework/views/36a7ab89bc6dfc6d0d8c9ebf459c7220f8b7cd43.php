   ...
   <div class="wrapper">
      <div class="overlayer_1" id="overlayer_1" style="display:none;">
         <div class="loader_1 flex-column justify-content-center align-items-centerx"  style=" background-color: transparent;">
           <div>
            <img class="loading_1" src="<?php echo e(asset('dist/img/Load.png')); ?>"  minheight="100" minwidth="120">
           </div>
         </div>
      </div>
         ...
         <ul class="navbar-nav ml-auto" id="fontcolor" >
            ...
            <li class="nav-item dropdown">
               <a class="nav-link" data-toggle="dropdown" href="#" id="fontcolor">
                  <i class="fas fa-user"></i>&nbsp;&nbsp;<?php echo e(Session::get('email')); ?>
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-image: linear-gradient(white, #D3D3D3);">
         ...
         <div class="user-panel  d-flex">
            <a  class="brand-link" style="margin-bottom: -4%;">
               <img src="<?php echo e(asset('dist/img/Tlogo.png')); ?>" class="brand-image  elevation" style="opacity: .8">
               <span class="brand-text"><img src="<?php echo e(asset('dist/img/Tarmallogo.png')); ?>"   style="margin-left:10%; width: 45%; "></span>
            </a>
         </div>
         <!-- Sidebar -->
            ...
            <nav class="mt-2">
               <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  ...
                  <li class="nav-item has-treeview fontcolor">
                     ...
                     <ul class="nav nav-treeview">
                        <li class="nav-item has-treeview " id="UserRole">
                           <a href="<?php echo e(route('reports.index')); ?>" class="nav-link" id="">
                              <i class="far fa-circle nav-icon fontcolor" ></i>
                              <p class="fontcolor">
                                  Transaction Report
                              </p>
                       ...
                       <ul class="nav nav-treeview">
                        <li class="nav-item has-treeview " id="UserRole">
                           <a href="<?php echo e(route('securities.index')); ?>" class="nav-link" id="">
                              <i class="far fa-circle nav-icon fontcolor" ></i>
                              <p class="fontcolor">
                                  Security Report
                              </p>
                     ...
                     <ul class="nav nav-treeview">
                        <li class="nav-item has-treeview " id="UserRole">
                           <a href="<?php echo e(route('suppliyers.index')); ?>" class="nav-link" id="">
                              <i class="far fa-circle nav-icon fontcolor" ></i>
                              <p class="fontcolor">
                                  Suppliyer Report
                              </p>
                         ...
                         <ul class="nav nav-treeview">
                        <li class="nav-item has-treeview " id="UserRole">
                           <a href="<?php echo e(route('scrap.index')); ?>" class="nav-link" id="">
                              <i class="far fa-circle nav-icon fontcolor" ></i>
                              <p class="fontcolor">
                                  Scrap Daily Report
                              </p>
                           ...
                           <ul class="nav nav-treeview">
                        <li class="nav-item has-treeview " id="UserRole">
                           <a href="<?php echo e(route('scrapdailyreports.index')); ?>" class="nav-link" id="">
                              <i class="far fa-circle nav-icon fontcolor" ></i>
                              <p class="fontcolor">
                                  ScrapDaily Report
                              </p>
