            ...
            <div class="row">
               <div class="col-md-6">
                  ...
                  <div class="row">
                     ...
                     <select class=" text-line form-control col-md-8"  name="DriverID" id="DriverID">
                        ...
                        <option value="<?php echo e($drivers->FirstName); ?>"><?php echo e($drivers->FirstName); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\gatepass\resources\views/scrap/index.blade.php ENDPATH**/ ?>