						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control form-control-sm " type="text"  name="ProductPrice" placeholder="Enter Theoratical Weight" autocomplete="off">
								</div>
							</div>
						</div>
					</div> 
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input class="form-control form-control-sm " type="text"  name="ProductUnit" placeholder="Enter Product Unit" autocomplete="off">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label>Secondary Unit <!-- <sup class="" style="font-size: 7px;"><i class="fas fa-asterisk text-danger"></i></sup> --></label>
									<input class="form-control form-control-sm "  type="text"  name="ProductSecUnit" placeholder="Enter Secondary Unit" autocomplete="off">
								</div>
							</div>
						</div>
					</div>
