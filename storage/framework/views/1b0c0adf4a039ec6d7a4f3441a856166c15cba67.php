		...
		<div class="card card-default">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<select class="form-control form-control-sm select2bs4" id="AccountID" name="AccountID">
			                   ...
			                   <?php if($driver->AccountID == $account->id): ?>
			                   {   
						...
						<div class="form-group">
							...
							<input class="form-control form-control-sm " type="text" id="LicenseNo" name="LicenseNo" value="<?php echo e($driver->licenseNo); ?>" placeholder="Enter National No" autocomplete="off">
						</div>
						<div class="form-group">
							<label>Notes</label>
					...
					<div class="col-md-6">
		            <div id="my_camera">	
		            	<img  class="myimg onepp"  id="CamScan" src="<?php echo e(asset('storage/app/public/webcam/'.$driver->licenseNo.'cam'.'.jpg')); ?>" name="">
		            </div>
             ...
             &nbsp;
            <div id="my_camera1">
            		<img  class="myimg onepp"  id="LicenseScan" src="<?php echo e(asset('storage/app/public/webcam/'.$driver->licenseNo.'.jpg')); ?>" name="">
            </div>
            <label for="cameraFile" id="mobcam" style="margin-left: 40%; margin-top: 2%; display: none;" >
              <span class="btn btn-block btn-outline-primary btn-xs"  >Take National ID Snap</span>
