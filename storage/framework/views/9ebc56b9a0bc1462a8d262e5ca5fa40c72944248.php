...
<section class="content">
  <div class="panel">
    <form class="space-y-2" id="myForm" action="<?php echo e(route('drivers.store')); ?>" method="POST">
      <?php echo csrf_field(); ?>
      <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
        ...
        <div class="flex-1 max-w-lg space-y-3">
          ...
          <div class="flex sm:flex-row flex-col" id="FirstNameField">
            ...
            <input type="text" placeholder="Enter First Name" class="form-input form-input-sm flex-auto" name="FirstName" id="FirstName" value="<?php echo e(old('FirstName')); ?>">
          </div>
          <div class="flex sm:flex-row flex-col" id="LastNameField">
            ...
            <input type="text" placeholder="Enter Last Name" class=" form-input form-input-sm flex-auto" name="LastName" id="LastName" value="<?php echo e(old('LastName')); ?>">
          </div>
          <div class="flex sm:flex-row flex-col" id="LicenseNoField">
            ...
            <input type="text" placeholder="Enter National Id" class="form-input form-input-sm flex-auto" name="LicenseNo" id="LicenseNo" value="<?php echo e(old('LicenseNo')); ?>" oninput="this.value = this.value.toUpperCase()">
          </div>
          <div class="flex sm:flex-row flex-col" id="ContactNoField">
            ...
            <input type="text" placeholder="Enter Contact No." class="form-input form-input-sm flex-auto" name="ContactNo" id="ContactNo" value="<?php echo e(old('ContactNo')); ?>" x-mask='999-9999999'>
          </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/drivers/create.blade.php ENDPATH**/ ?>