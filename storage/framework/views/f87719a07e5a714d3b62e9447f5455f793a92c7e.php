					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<select class="form-control form-control-sm select2bs4" id="AccountID" name="AccountID">
			                   ...
			                   {    <option></option>
			                     	<option   value="<?php echo e($driver->id); ?>"><?php echo e($account->CompanyName); ?></option>
			                   }
			                   <?php else: ?>
			                   {   
			                      
			                      <option  selected=""value="<?php echo e($driver->id); ?>"><?php echo e($account->CompanyName); ?></option>
			                   }                       
			                   <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\resources\views/drivers/edit.blade.php ENDPATH**/ ?>