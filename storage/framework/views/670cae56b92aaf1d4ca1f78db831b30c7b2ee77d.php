...
<section class="content" >
		...
		<div class="panel">
			<form class="space-y-5" id="myForm" action="<?php echo e(route('vehicles.store')); ?>" method="POST">
				<?php echo csrf_field(); ?>
			    <div class="flex sm:flex-row flex-col" id="VehicleTypeField">
			        ...
			        <select id="VehicleType" name="VehicleType" class="text-xs flex-1 form-input">
							    ...
							    <option <?php echo e($vtypes->FieldValue ==old('VehicleType')?'selected':''); ?> value="<?php echo e($vtypes->FieldValue); ?>"><?php echo e($vtypes->FieldValue); ?></option>
			    ...
			    <div class="flex sm:flex-row flex-col" id="VehicleNoField">
					    ...
					    <input type="text" placeholder="Enter Vehicle No." class="text-xs form-input flex-1" name="VehicleNo" id="VehicleNo" value="<?php echo e(old('VehicleNo')); ?>" oninput="this.value = this.value.toUpperCase()">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/vehicles/create.blade.php ENDPATH**/ ?>