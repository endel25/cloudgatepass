            ...
            <div class="row">
               ...
               <div class="col-md-6" id="camera_Show" style="display: none;">
                  <div id="my_camera"><img src="<?php echo e(asset('dist/img/webcam.png')); ?>" id="V_CamScan"></div>
                      ...
                      <div>
                         <button type="button" id="camof" class="btn btn-block btn-outline-primary btn-xs col-md-6" value="Take Snapshot" onClick="Take_Stream()" style="margin-left: 22%;">Start Stream</button>    
                      </div> 
               </div>
            </div>
         </div>
           ...
           $.ajax({
               ...
               cache: false,
                  success: function(response) {
                     ...
                     if (response.error) 
                     {
                        toastr.success(response.error).fadeOut(6000);
                     }
                     if (id != '') 
                     {
                        var id =response.id;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\resources\views/gatepass/create.blade.php ENDPATH**/ ?>