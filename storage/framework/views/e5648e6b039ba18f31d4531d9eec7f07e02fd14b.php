...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="row">
      ...
      <!-- ./col -->
      <div <?php if($userrole_permissions_status[2]->IsRead==1 || $userrole_permissions_status[3]->IsRead==1): ?>onclick="document.location='<?php echo e(URL::to('/')); ?>/Loading';" style="cursor: pointer;" <?php endif; ?> class="col-lg-3 col-6" >
        <!-- small box -->
        <div class="small-box bg-secondary">
          <div class="inner">
      ...
      <!-- ./col -->
      <div <?php if($userrole_permissions_status[3]->IsRead==1 || $userrole_permissions_status[4]->IsRead==1): ?>onclick="document.location='<?php echo e(URL::to('/')); ?>/GatepassIssued';" style="cursor: pointer;" <?php endif; ?> class="col-lg-3 col-6" >
        <!-- small box -->
        <div class="small-box bg-secondary">
          <div class="inner">
      ...
      <!-- ./col -->
      <div <?php if($userrole_permissions_status[4]->IsRead==1): ?>onclick="document.location='<?php echo e(URL::to('/')); ?>/ExitApproved';" style="cursor: pointer;"<?php endif; ?> class="col-lg-3 col-6" >
        <!-- small box -->
        <div class="small-box bg-secondary">
          <div class="inner">
