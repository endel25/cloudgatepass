         ...
         <div class="col-md-6">
            <div class="form-group">
               <div class="row">
                  ...
                  &nbsp;
                  &nbsp;
                  <input class="form-group col-md-9" type="text" required="" name="CompanyName" style="font-size: 14px;" id=""  autocomplete="off">
               </div>
            </div>
         </div>
         <!-- <div class="col-md-3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\resources\views/companies/create.blade.php ENDPATH**/ ?>