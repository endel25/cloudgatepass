...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      ...
      <a type="button" href="<?php echo e(route('locations.create')); ?>" class="btn btn-sm btn-l btn-primary rounded-full">Add Location</a>
   </div>
</section>
<section>
   <div class="panel">
      <table id="myTable" class="table-hover whitespace-nowrap">
         ...
         <tbody>
            ...
            <tr>
               <td><?php echo e($location->LocationCode); ?></td>
               <td><?php echo e($location->LocationName); ?></td>
               <td>
                  <div class="flex items-center  gap-4" >
                     <a href="<?php echo e(route('locations.edit',$location->id)); ?>" title="EDIT">
                    ...
                    <a onclick="showAlert('<?php echo e(URL::to('/')); ?>/locations/<?php echo e($location->id); ?>/delete')" title="DELETE">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/locations/index.blade.php ENDPATH**/ ?>