...
<section class="content-header">
  <div class="mb-2 flex items-center justify-between">
    ...
    <a type="button" href="<?php echo e(route('drivers.index')); ?>" class="btn btn-sm btn-l btn-primary rounded-full">Back</a>
  </div>
</section>
<section class="content">
  <div class="panel">
    <form class="space-y-2" id="myForm" action="<?php echo e(route('drivers.update',$driver->id)); ?>" method="POST">
      <?php echo csrf_field(); ?>
        ...
        <div class="flex-1 max-w-lg space-y-4">
          <div class="flex sm:flex-row flex-col" id="PersonTypeField">
            ...
            <select id="PersonType" name="PersonType" class="text-xs  form-input">
              <option <?php echo e($driver->PersonType == 'Driver'?'selected':''); ?> value="Driver">Driver</option>     
              <option <?php echo e($driver->PersonType == 'Visitor'?'selected':''); ?> value="Visitor">Visitor</option>     
            </select>
          </div>
          <div class="flex sm:flex-row flex-col" id="FirstNameField">
            ...
            <input type="text" placeholder="Enter First Name" class="text-xs form-input flex-auto" name="FirstName" id="FirstName" value="<?php echo e($driver->FirstName); ?>">
          </div>
          <div class="flex sm:flex-row flex-col" id="LastNameField">
            ...
            <input type="text" placeholder="Enter Last Name" class="text-xs form-input flex-auto" name="LastName" id="LastName" value="<?php echo e($driver->LastName); ?>">
          </div>
          <div class="flex sm:flex-row flex-col" id="LicenseNoField">
            ...
            <input type="text" placeholder="Enter National Id" class="text-xs form-input flex-auto" name="LicenseNo" id="LicenseNo" value="<?php echo e($driver->LicenseNo); ?>" oninput="this.value = this.value.toUpperCase()">
          </div>
          <div class="flex sm:flex-row flex-col" id="ContactNoField">
            ...
            <input type="text" placeholder="Enter Contact No." class="text-xs form-input flex-auto" name="ContactNo" id="ContactNo" value="<?php echo e($driver->ContactNo); ?>" x-mask='999-9999999'>
          </div>
          ...
          <div class="webcam-container">
            <div class="webcam-wrapper">
              <div id="webcam1" class="webcam-feed">
                <img src="<?php echo e(asset('storage/app/public/webcam/'.$driver->LicenseNo.'_driver'.'.jpg')); ?>" width="320" style="height: -webkit-fill-available;">
              </div>
          ...
          <div class="webcam-container">
            <div class="webcam-wrapper">
              <div id="webcam2" class="webcam-feed">
                <img src="<?php echo e(asset('storage/app/public/webcam/'.$driver->LicenseNo.'_national'.'.jpg')); ?>" width="320" style="height: -webkit-fill-available;">
              </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/drivers/edit.blade.php ENDPATH**/ ?>