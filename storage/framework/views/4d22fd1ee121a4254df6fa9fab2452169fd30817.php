...
<section class="content" >
		...
		<div class="panel">
			<form class="space-y-5" id="myForm" action="<?php echo e(route('locations.store')); ?>" method="POST">
				<?php echo csrf_field(); ?>
			    <div class="flex sm:flex-row flex-col" id="LocationCodeField">
			        ...
			        <input type="text" placeholder="Enter Location Code" class="text-xs form-input flex-1" name="LocationCode" id="LocationCode" value="<?php echo e(old('LocationCode')); ?>">
			    </div>
			    <div class="flex sm:flex-row flex-col" id="LocationNameField">
				    ...
				    <input type="text" placeholder="Enter Location Name" class="text-xs form-input flex-1" name="LocationName" id="LocationName" value="<?php echo e(old('LocationName')); ?>" >
				</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/locations/create.blade.php ENDPATH**/ ?>