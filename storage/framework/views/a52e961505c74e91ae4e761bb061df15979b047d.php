  ...
  function productAddToTable() {
   ...
   $("#Warehouse_create").click(function(e) 
   {
       ...
       if (warehouseNumber!='' && warehouseName!='') 
       {
           $.ajax({
               type: "POST",
               url: "<?php echo e(URL::to('/')); ?>/Warehouse/Warehousecreate",
               data: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\gatepass\resources\views/warehouse/create.blade.php ENDPATH**/ ?>