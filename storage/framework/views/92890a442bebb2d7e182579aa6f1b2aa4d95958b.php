...
<section class="content-header">
   <div class="mb-5 flex items-center justify-between">
      ...
      <a type="button" href="<?php echo e(route('transporter.create')); ?>" class="btn btn-sm btn-l btn-primary rounded-full">Add Transporter</a>
   </div>
</section>
<section>
   <div class="panel">
      <table id="myTable" class="table-hover whitespace-nowrap">
         ...
         <tbody>
            <?php $__currentLoopData = $transpoter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transpoters): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
               <td><?php echo e($transpoters->TransporterCode); ?></td>
               <td><?php echo e($transpoters->TransporterName); ?></td>
               <td>
                  <div class="flex items-center  gap-4" >
                     <a href="<?php echo e(route('transporter.edit',$transpoters->id)); ?>" title="EDIT">
                    ...
                    <a onclick="showAlert('<?php echo e(URL::to('/')); ?>/transporter/<?php echo e($transpoters->id); ?>/delete')" title="DELETE">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/transporters/index.blade.php ENDPATH**/ ?>