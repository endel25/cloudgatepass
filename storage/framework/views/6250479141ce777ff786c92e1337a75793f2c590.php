	         ...
	         <div class="card">
	            <div class="card-body">
	               <table id="example1" class="table table-bordered table-striped">
	                  ...
	                  <tbody> 
	                   <?php $__currentLoopData = $Verify; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Rejected): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
	                     <tr>
	                     	  <th>GP<?php
														if ($Rejected->id<10) {
															echo "0".$Rejected->id;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\gatepass\resources\views/Verify.blade.php ENDPATH**/ ?>