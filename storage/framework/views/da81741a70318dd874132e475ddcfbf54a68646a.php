    ...
    <section>
       ...
       <div class="panel">
        <table id="myTable" class="table-hover whitespace-nowrap">
            ...
            <tbody>
                 <?php $__currentLoopData = $all_rec_loading_unloading; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/gatepass/loadingunloading.blade.php ENDPATH**/ ?>