            ...
            <div class="row">
               <div class="col-md-6">
                  ...
                  <div class="form-group">
                     ...
                     <input class="form-control form-control-sm"  required=""  type="text"  value="<?php echo e($user->email); ?>" name="email" placeholder=" Enter User Name" autocomplete="off">
                  </div>
                  <div class="form-group">
...
unset($__errorArgs, $__bag); ?>
                  ...
                  <div class="form-group">
                     ...
                     <input class="form-control form-control-sm " type="text" name="ContectNo" value="<?php echo e($user->ContectNo); ?>"  placeholder=" Enter Contect No" autocomplete="off">
                  </div>
               </div>
               <div class="col-md-6">
                  ...
                  <div class="form-group" id="WarehouseID" >
                     ...
                     <select class="form-control form-control-sm "  name="WarehouseId" >
                           ...
                           <?php if($user->WarehouseId == $warehouse->id): ?>
                           {
                             <option selected value="<?php echo e($warehouse->id); ?>"><?php echo e($warehouse->warehouseNumber); ?></option>
                           }
                           <?php else: ?>
                           {   
                              <option value="<?php echo e($warehouse->id); ?>"><?php echo e($warehouse->warehouseNumber); ?></option>
                           }                       
                           <?php endif; ?>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                     </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\resources\views/users/edit.blade.php ENDPATH**/ ?>