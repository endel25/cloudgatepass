...
<section class="content" >
		...
		<div class="panel">
			<form class="space-y-5" id="myForm" action="<?php echo e(route('products.update',$product->id)); ?>" method="POST">
				<?php echo csrf_field(); ?>
			    ...
			    <div class="flex sm:flex-row flex-col" id="ProductTypeField">
				    ...
				    <option <?php echo e($ptypes->FieldValue == $product->ProductType ?'selected':''); ?> value="<?php echo e($ptypes->FieldValue); ?>"><?php echo e($ptypes->FieldValue); ?></option>
			    ...
			    <div class="flex sm:flex-row flex-col" id="ProductNameField">
				    ...
				    <input type="text" placeholder="Enter Product Name" class="text-xs form-input flex-1" name="ProductName" id="ProductName" value="<?php echo e($product->ProductName); ?>" >

				</div>
			    <div class="flex sm:flex-row flex-col" id="ProductCodeField">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Product Code</label>
			        <input type="text" placeholder="Enter Product Code" class="text-xs form-input flex-1" name="ProductCode" id="ProductCode" value="<?php echo e($product->ProductCode); ?>">
			    </div>
			    <div class="flex sm:flex-row flex-col" id="ProductUnitField">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Product Unit</label>
			        <input type="text" placeholder="Enter Product Unit" class="text-xs form-input flex-1" name="ProductUnit" id="ProductUnit" value="<?php echo e($product->ProductUnit); ?>">
			    </div>
			    <div class="flex sm:flex-row flex-col">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Product Price</label>
			        <input type="number" step="any" placeholder="Enter Product Price" class="text-xs form-input flex-1" name="ProductPrice" id="ProductPrice" value="<?php echo e($product->ProductPrice); ?>">
			    </div>
			    <div class="flex sm:flex-row flex-col">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Theoratical Weight</label>
			        <input type="number" step="any" placeholder="Enter Theoratical Weight" class="text-xs form-input flex-1" name="TheoraticalWeight" id="TheoraticalWeight" value="<?php echo e($product->TheoraticalWeight); ?>">
			    </div>
			    <div class="flex sm:flex-row flex-col">
			        <label  class="mb-0 sm:w-1/4 sm:ltr:mr-2 rtl:ml-2">Notes</label>
			       	<textarea class="text-xs flex-1 form-input"><?php echo e($product->NOtes); ?></textarea>
			    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\cloud-gatepass\resources\views/products/edit.blade.php ENDPATH**/ ?>